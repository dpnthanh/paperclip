    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
            ...
            {!isMobile && !collapseLocked ? (
              peeking ? (
                <Button
                  ...
                  size="icon-sm"
                  className="text-muted-foreground shrink-0"
                  aria-label={t("sidebar.keepSidebarExpanded", { defaultValue: "Keep sidebar expanded" })}
                  title={t("sidebar.keepSidebarExpanded", { defaultValue: "Keep sidebar expanded" })}
                ...
                <Button
                  ...
                  aria-label={collapsed ? t("sidebar.expandSidebar", { defaultValue: "Expand sidebar" }) : t("sidebar.collapseSidebar", { defaultValue: "Collapse sidebar" })}
                  title={collapsed ? t("sidebar.expandSidebar", { defaultValue: "Expand sidebar" }) : t("sidebar.collapseSidebar", { defaultValue: "Collapse sidebar" })}
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 pointer-coarse:gap-3 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/dashboard" label={t("sidebar.nav.dashboard", { defaultValue: "Dashboard" })} icon={LayoutDashboard} liveCount={liveRunCount} />
          <SidebarNavItem
            to="/inbox"
          ...
          {conferenceRoomChatEnabled ? (
            <SidebarNavItem to="/board-chat" label={t("sidebar.nav.conferenceRoom", { defaultValue: "Conference Room" })} icon={MessagesSquare} />
          ) : null}
        </div>

        <SidebarSection label={t("sidebar.section.work", { defaultValue: "Work" })} collapsible={{ open: workOpen, onOpenChange: setWorkOpen }}>
          <SidebarNavItem to="/issues" label={t("sidebar.nav.tasks", { defaultValue: "Tasks" })} icon={CircleDot} />
          {showCases ? (
            <SidebarNavItem to="/cases" label={t("sidebar.nav.cases", { defaultValue: "Cases" })} icon={Layers} textBadge={t("sidebar.badge.beta", { defaultValue: "beta" })} />
          ) : null}
        ...
        <SidebarSection label={t("sidebar.section.company", { defaultValue: "Company" })} collapsible={{ open: companyOpen, onOpenChange: setCompanyOpen }}>
          ...
          <SidebarNavItem to="/company/settings" label={t("settings.nav.settings", { defaultValue: "Settings" })} icon={Settings} />
        </SidebarSection>
